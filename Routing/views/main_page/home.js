...
all their memories on our servers.
    ...
    <div class="alertBar">
        ...
        <a href="" class="alertBar__btn">Deny</a>
    </div>
    <section class="stepsSection">
        ...
        <div class="stepsSection__steps">
            ...
            <div class="stepsSection__stepbox">
                ...
                <i class="icon-folder stepsSection__icon"></i>
        ...
        <a onclick="router.loadRoute('register')" class="stepsSection__Btn">Start now!</a>
    </section>
    <section class="services" id="services">
        ...
        <div class="services__box">
            ...
            <div class="services__serviceBox services__box--1">
                ...
                <i class="services__service-icon services__service-icon--1 icon-folder "></i>
            </div>
